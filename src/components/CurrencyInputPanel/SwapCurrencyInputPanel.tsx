...
const InputRow = styled.div<{ selected: boolean; redesignFlag: boolean; hideInput: boolean; disabled: boolean }>`
  ${({ theme }) => theme.flexRowNoWrap}
  align-items: center;
  justify-content: space-between;
  padding: ${({ selected, redesignFlag }) =>
    redesignFlag ? '0px' : selected ? ' 0.2rem 1rem 0.01rem 1rem' : '0.2rem 1rem 0.2rem 1rem'};
  border-radius: 5px;
