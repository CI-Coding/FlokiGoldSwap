...
export const USDC_FLOKIGOLD = new Token(
  SupportedChainId.FLOKIGOLD,
  '0xBD173B4315D8d91819d09f5d28DeDCcd53F0F595',
  18,
  'RDT',
  'RandomToken'
)
export const USDC: { [chainId in SupportedChainId]: Token } = {
  ...
  [SupportedChainId.FLOKIGOLD]: USDC_FLOKIGOLD,
}
...
export const FUSD_FGOLD = new Token(
  SupportedChainId.FLOKIGOLD,
  '0x10c892A6EC43a53E45D0B916B4b7D383B1b78C0F',
  18,
  'FUSD',
...
export const UNI: { [chainId: number]: Token } = {
  ...
  [SupportedChainId.FLOKIGOLD]: new Token(SupportedChainId.FLOKIGOLD, UNI_ADDRESS[117], 18, 'UNI', 'Uniswap'),
}
...
export const WRAPPED_NATIVE_CURRENCY: { [chainId: number]: Token | undefined } = {
  ...
  [SupportedChainId.FLOKIGOLD]: new Token(
    SupportedChainId.FLOKIGOLD,
    '0xC7EeBFFd6618a1B830A3c3970f5709205b3Ef9a0',
    18,
    'WFGOLD',
    'Wrapped FGOLD'
  ),
...
export const TOKEN_SHORTHANDS: { [shorthand: string]: { [chainId in SupportedChainId]?: string } } = {
  USDC: {
    ...
    [SupportedChainId.FLOKIGOLD]: USDC_FLOKIGOLD.address,
  },
}
